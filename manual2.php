  ...
  border-radius: 50%;
	...
	<tbody>
		...
		<tr>
			...
			<td bgcolor=#D3D3D3>
                <?php 
                    if($pecah['data']>500 && $pecah['data']<700){
                        echo $pecah['data'];
                    }
...
<hr/>
            <h5 class="center">Tabel Volume Kolam (Liter)</h5>
            <br>
	...
	<tbody>
		...
		<tr>
			<td bgcolor=#green><?php echo $nomor; ?></td>
			<td bgcolor=#D3D3D3><?php echo $pecah['volume(liter)']; ?></td>
			<td bgcolor=#D3D3D3></td>
			<td bgcolor=#D3D3D3></td>
			<td bgcolor=#D3D3D3></td>
			<td bgcolor=#D3D3D3></td>
...
<a>Grafik Pengujian Ketinggian Air<a href="test.php"> Click Here</a> <br>
<a>Grafik Pengujian Volume Kolam (liter)<a href="volume.php"> Click Here</a>
<br>
<br><br>
<br><br>
<br>
